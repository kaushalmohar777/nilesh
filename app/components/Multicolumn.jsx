...
<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
  <div className='bg-Bg1 p-6 rounded-lg shadow-md text-center'>
  ...
  <div className='bg-{Bg2} p-6 rounded-lg shadow-md text-center'>
  ...
  <div className='bg-{Bg3} p-6 rounded-lg shadow-md text-center'>
